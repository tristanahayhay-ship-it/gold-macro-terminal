...
Yêu cầu bắt buộc: Viết bằng tiếng Việt. Chỉ trả về văn bản nhận định dạng HTML (dùng thẻ <b>, <br>), tuyệt đối không dùng câu văn mẫu lặp đi lặp lại."""
    ...
    # ===============================================================================================
# ===================================================================================================
# 4. TIN TỨC & CỔ PHIẾU (MÃ NGUỒN CHUẨN 100% - KHÔNG CHỨA DỮ LIỆU MẪU VIẾT TAY)
# ===================================================================================================
    ...
    def get_realtime_enterprise_news():
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                for item in root.findall(".//item")[:5]:
                    ...
                    if pub_date_str:
                        try:
                            # Tách và loại bỏ khoảng trắng dư thừa một cách chính xác
                            clean_date = pub_date_str.rsplit(' ', 1)[0].strip()
                            # Khớp chính xác định dạng chuỗi từ Yahoo RSS: Sun, 12 Jul 2026 01:41:00
        ...
        # KHÔNG DÙNG TIN MẪU VIẾT TAY: Trả về bảng rỗng nếu Yahoo sập mạng hoàn toàn
    ...
    def render_live_stock_section():
        ...
        if not df_news.empty:
            ...
            st.info("Đang kết nối và đồng bộ dòng tin tức trực tuyến trực tiếp từ Yahoo Finance...")
